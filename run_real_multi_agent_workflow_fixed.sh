#!/bin/bash
# Run the fixed real multi-agent workflow
...
# Run the fixed real multi-agent workflow
echo "Running fixed real multi-agent workflow for $NAME at $URL..."
python real_multi_agent_workflow_fixed.py --url "$URL" --name "$NAME"
