#!/usr/bin/env python3
"""
Generate Real Tests (Fixed V2)
=========================
This script generates real tests for a website using synchronous Playwright with improved reliability.
"""
    ...
    def test_invalid_login(self):
        ...
        with sync_playwright() as playwright:
            ...
            try:
                ...
                page.wait_for_selector(".oxd-alert-content-text", timeout=30000)
